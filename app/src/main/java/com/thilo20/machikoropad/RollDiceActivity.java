...
/**
 * Screen to enter the dice roll result. Supports rolling 1 or 2 dice (requires card train station).
 * Supports extra roll (requires card amusement park) when both dice show the same number. Supports
 * +2 (requires extension/card harbour) when dice sum is 10 or more.
 */
public class RollDiceActivity extends AppCompatActivity {
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    String caption = getResources()
        .getString(R.string.roll_dice, game.getCurrentPlayer().getName());
  ...
  private void initDiceButton(@IdRes int buttonId, final int number,
  ...
  private void checkHarbour() {
    ...
    if (game.isHarbour()
      ...
      builder.setPositiveButton(R.string.yes, new DialogInterface.OnClickListener() {
        ...
        public void onClick(DialogInterface dialog, int which) {
          Logger.getLogger(getClass().getName())
              .log(Level.INFO, "harbour used, sum=" + (dice1 + dice2 + 2));
      ...
      builder.setNegativeButton(R.string.no, new DialogInterface.OnClickListener() {
        ...
        public void onClick(DialogInterface dialog, int which) {
          Logger.getLogger(getClass().getName())
              .log(Level.INFO, "harbour not used, sum=" + (dice1 + dice2));
  ...
  private void nextAction() {
    ...
    if (useDoubleRoll) {
      log.log(Level.INFO,
          "Player " + game.getCurrentPlayer().getNumber() + " rolled " + dice1 + "+" + dice2 + "="
              + (dice1 + dice2));
      // increment counter
